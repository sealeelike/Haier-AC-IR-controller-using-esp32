...
## 目录
_本branch用于调试，开发。完整app移步[此branch](https://github.com/sealeelike/Haier-AC-IR-controller-using-esp32/tree/App-Build)_
...
分别检查[屏幕](Hardware%20Check/screen%20test.py),[红外接收器](Hardware%20Check/IR_Receiver.py),[wifi](Hardware%20Check/wificonnect.py)。其中屏幕需要[sh1106驱动](Hardware%20Check/sh1106.py)
